...
(function() { 
    ...
    window.lc_select = function(attachTo, options = {}) {
        ...
        this.append_dd = function() {
            ...
            // build code
            let code = '<div id="lc-select-dd" class="'+ multiple_class +' '+ addit_classes +'" data-parent-name="'+select.getAttribute('name')+'">';
            ...
            if(typeof(options.on_ddAppended) == 'function') {
             options.on_ddAppended.call(this, select);
            }
        };
        ...
        this.search_options = function() {
            ...
            if(val.length < 2) {
                ...
                if(no_results) {
                    ...
                    no_results_li.remove(); // убрать, если во время поиска в косоли ошибка    
                }
            }
        };
